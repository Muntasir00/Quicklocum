const Service = () => {
  return (
    <div className='pb-28 bg-white lg:px-7 2xl:px-60'>
      <div className='rounded-[40px] flex flex-col xl:flex-row gap-6 bg-gradient-to-b from-[#7ED958] to-[#43732F] justify-center items-stretch p-7 2xl:p-20'>
        {/* Card 1 */}
        <div className='rounded-2xl p-10 flex flex-col gap-8 bg-[#FFFFFF] w-full xl:w-1/2'>
